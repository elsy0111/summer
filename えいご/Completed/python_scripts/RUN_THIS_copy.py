...
def export_eng(row):
    ...
    eng = ttk.Label(text=row[0], font=('游明朝 Light', 105 ), foreground = "white",background= "black")
...
def export_jp(row):
    ...
    jp = ttk.Label(text=row[1], font=('游明朝 Light', 90 ), foreground = "white",background = "black")
